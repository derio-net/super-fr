...
`fr.bridge.dispatch.dispatch_phase` — see that module for the canonical
...
from fr.bridge import dedup as _dedup
from fr.bridge import metrics as _metrics
from fr.bridge import slots as _slots
from fr.bridge.dispatch import MCPDispatch, build_card_title, dispatch_phase
...
def tick(
    ...
    *,
    ...
    `vk-synced`, delegate to `fr.bridge.dispatch.dispatch_phase` to
