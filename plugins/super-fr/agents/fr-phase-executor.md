...
Keep the prose minimal; the journal holds the detail. Write the result and every journal entry in Simplified Technical English, as the `ste-output-tone` rule specifies.
