...
from vk.commands.common import PlanReport, build_plan_report, require_migrated_layout
from vk.labels import VK_SYNCED
...
_LIFECYCLE = ("vk-ready", "vk-blocked", "in-progress", "pr-ready", "manual")
...
def _report_json(report: PlanReport) -> dict[str, Any]:
    from vk.commands.apply_cmd import _mutation_to_json
