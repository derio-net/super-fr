...
INVENTORY: dict[str, str] = {
    ...
    "B": "DELETED",
    "C": "fr.render",
    "D": "fr.bridge.workspaces",
    "E": "fr.bridge.lifecycle",
    "F": "fr.bridge.pr_state",
    "G": "fr.bridge.dispatch",
    "H": "fr.bridge.slots",
    "I": "fr.bridge.dedup",
    "J": "fr.bridge.config",
    "K": "fr.bridge.prompt",
...
DELETED_SHIMS: tuple[str, ...] = (
    "fr.bridge.body_parse",
    "fr.bridge.gh_ready_listing",
)
